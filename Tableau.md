...
The dataset contains **232,726 rows** of track-level data, with columns including genre, artist_name, track_name, track_id, and popularity, alongside a set of audio features generated by Spotify's algorithm: acousticness, danceability, duration_ms, energy, instrumentalness, key, liveness, loudness, mode, speechiness, tempo, time_signature, and valence.
